...
('john.doe@gmail.com', 9845, 'John', 'Doe', '1985-03-15', '2024-11-01', '12:34:56', 'debit', 4111111111111111, 'John Doe', '2025-05-15'),
('john.doe@gmail.com', 5382, 'Anna', 'Doe', '2005-01-01', '2024-11-01', '12:35:40', 'credit', 4111111111111111, 'John Doe', '2025-05-15'),
('john.doe@gmail.com', 1276, 'John', 'Doe', '1985-03-15', '2024-11-02', '13:15:22', 'debit', 5123456789012345, 'John Doe', '2026-08-10'),
('bob.johnson@aol.com', 1139, 'Bob', 'Johnson', '1980-05-05', '2024-11-06', '12:34:12', 'debit', 6011222233334444, 'Bob Johnson', '2032-09-15'),
('bob.johnson@aol.com', 8421, 'Donald', 'Johnson', '1987-11-01', '2024-11-07', '16:30:12', 'credit', 4111111113333333, 'Bob Johnson', '2029-07-11'),
('bob.johnson@aol.com', 6187, 'Bob', 'Johnson', '1980-05-05', '2024-11-08', '12:45:30', 'debit', 371449635446631, 'Bob Johnson', '2031-06-30'),
('bob.johnson@aol.com', 8435, 'Vincent', 'Johnson', '2006-08-19', '2024-11-08', '12:46:10', 'credit', 371449635446631, 'Bob Johnson', '2031-06-30'),
('emma.green@icloud.com', 5037, 'Emma', 'Green', '1995-01-22', '2024-11-09', '08:30:50', 'debit', 6011000990139424, 'Emma Green', '2030-02-20'),
('emma.green@icloud.com', 9742, 'Lebron', 'Green', '1997-06-05', '2024-11-09', '08:32:15', 'debit', 6011000990139424, 'Emma Green', '2030-02-20'),
('kevin.li@protonmail.com', 5918, 'Kevin', 'Li', '1993-12-05', '2024-11-10', '09:15:25', 'debit', 4111111112223333, 'Kevin Li', '2029-06-30'),
('kevin.li@protonmail.com', 2389, 'Rammon', 'Li', '2011-09-18', '2024-11-10', '09:16:45', 'credit', 4111111112223333, 'Kevin Li', '2029-06-30'),
('kevin.li@protonmail.com', 9042, 'Kevin', 'Li', '1993-12-05', '2024-11-10', '10:05:22', 'credit', 5123456789012345, 'Kevin Li', '2032-04-25');
